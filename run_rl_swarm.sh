...
export P2P_DAEMON_STARTUP_TIMEOUT=120  # 增加到 120 秒
export P2P_DAEMON_DEBUG=true
export P2P_DAEMON_LOG_LEVEL=debug
export P2P_DAEMON_LOG_FILE="$ROOT/p2p_daemon.log"  # 添加日志文件
...
export PYTORCH_MPS_ALLOCATOR_POLICY=eager_gc
export LIBP2P_LISTEN_ADDRS="/ip4/127.0.0.1/tcp/38333,/ip4/0.0.0.0/tcp/38333"  # 添加本地回环地址
...
DEFAULT_HOST_MULTI_ADDRS="/ip4/127.0.0.1/tcp/38333"  # 使用本地回环地址
...
# Set up trap to display runtime on exit
trap 'echo -e "\nScript terminated unexpectedly. $(display_runtime)"' EXIT
